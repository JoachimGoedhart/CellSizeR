...
output: 
  flexdashboard::flex_dashboard:
    ...
    navbar:
      - { title: "", href: "https://www.addgene.org", align: right }
runtime: shiny
---
...
_This dashboard summarizes and displays the data that is measured by students in the course "Cellulaire Oncologie". Cell size measurements were done with microscopy on human cheek cells._
